...
#         "You are a medical chatbot, your work is to guess the disease...",
#         f"input:{inp_txt}",
#         "output:",
#     ])
...
# # 🔹 Allow ALL origins (Removes CORS restrictions)
...
# def process_input():
#     user_input = request.json.get('userInput')  # Get input from frontend
#     response = generate_res(user_input)
#     return jsonify(response=response)  # Send response as JSON
